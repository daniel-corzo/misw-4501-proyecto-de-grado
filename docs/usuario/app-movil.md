...
Al abrir la app por primera vez verás la pantalla de bienvenida. Puedes:
...
La app tiene una barra de navegación en la parte inferior con las secciones principales:

| Sección | Función |
|---|---|
| **Inicio / Buscar** | Buscador de hoteles |
| **Reservas** | Listado y gestión de tus reservas |
| **Configuración** | Perfil, preferencias y cerrar sesión |
...
## Gestionar reservas desde la app

1. Ve a la sección **Reservas**.
2. Filtra por **Activas**, **Canceladas** o **Pasadas**.
3. Toca cualquier reserva para ver su detalle completo.
4. Desde el detalle puedes ver el **código QR** de check-in o **cancelar** la reserva.
...
1. Ve a **Configuración** en la barra inferior.
